...
//DEKLARASI KOMPONEN
  JFrame window = new JFrame("MAIL - Email In");
  ...
  public EmailIn(User n) {
    ...
    if (rd.readEmailIn(n) == null) {
      JOptionPane.showMessageDialog(null, "Tidak Ada Data");
      tabel = new JTable(null, namaKolom); //tabel merupakan variabel untuk tabelnya dengan isi tablemodel
    } else {
      tabel = new JTable(rd.readEmailIn(n), namaKolom); //tabel merupakan variabel untuk tabelnya dengan isi tablemodel
    }
